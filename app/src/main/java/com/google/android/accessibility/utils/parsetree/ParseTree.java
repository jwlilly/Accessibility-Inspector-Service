...
public class ParseTree {
  ...
  private static @OperatorClass int getOperatorClass(String value) {
  ...
  private static @OperatorClass int getOperatorClass(@Operator int operator) {
    switch (operator) {
  ...
  private static @Operator int getOperator(String value) {
    if (value.length() == 1) {
