...
public class CollectionState {
  ...
  /**
   * @return Either {@link Role#ROLE_LIST} or {@link
   *     Role#ROLE_GRID} if there is a collection, or {@link
   *     Role#ROLE_NONE} if there isn't one.
   */
   ...
   *     Role#ROLE_PAGER}, representing a collection of
